...
* Passa il pacchetto di feed di dati a un endpoint di servizio OData da ATOM: se esegue l'aggiornamento alla versione CTP2 di NuGet, assicurarsi di aggiungere il seguente URL come origine del pacchetto: [http://go.microsoft.com/fwlink/?LinkID=204820](http://go.microsoft.com/fwlink/?LinkID=204820).
