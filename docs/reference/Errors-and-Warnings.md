...
Gli errori e gli avvisi elencati di seguito sono disponibili solo con i progetti [basati su PackageReference](../consume-packages/package-references-in-project-files.md) e NuGet 4.3.0 +. NuGet rispetta anche le proprietà di MSBuild per non visualizzare gli avvisi o elevarle agli errori. Per altre informazioni, vedere [Procedura: Non visualizzare gli](/visualstudio/ide/how-to-suppress-compiler-warnings) avvisi del compilatore nella documentazione di Visual Studio.
