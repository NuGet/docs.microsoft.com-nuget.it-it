...
| **Soluzione** | Pacchetti con vincoli di dipendenza in versioni esatte non consentono altri pacchetti per incrementare la versione, se necessario. Aggiungere un riferimento al pacchetto direttamente (nel file di progetto) con la versione esatta richiesta. |
