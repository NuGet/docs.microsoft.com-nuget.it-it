...
---
# <a name="44-rtm-release-notes"></a>Note sulla versione per 4.4 RTM
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>Collegamento ai problemi di GitHub risolti nella versione 4.4 RTM
