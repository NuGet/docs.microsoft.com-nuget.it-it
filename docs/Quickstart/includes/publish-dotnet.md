1. <span data-ttu-id="9a11e-101">Passare alla cartella contenente il file `.nupkg`.</span><span class="sxs-lookup"><span data-stu-id="9a11e-101">Change to the folder containing the `.nupkg` file.</span></span>
