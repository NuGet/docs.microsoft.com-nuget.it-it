...
La correzione consiste nell'installare Visual Studio 2012 Update, ad esempio Visual Studio 2012 Update 2.
...
Se si tenta di disinstallare NuGet tramite Gestione estensioni di Visual Studio, il pulsante Disinstalla potrebbe risultare disabilitato. Per l'installazione o la disinstallazione NuGet richiede l'accesso con privilegi di amministratore. Riavviare Visual Studio come amministratore per disinstallare l'estensione. NuGet non richiede l'accesso con privilegi di amministratore per l'uso.
...
Se è installato Visual Studio 2010 SP1 Beta, potrebbe verificarsi un arresto anomalo se si lascia aperta la console di Gestione pacchetti e si chiude Visual Studio. Si tratta di un problema noto di Visual Studio e verrà risolto nella versione SP1 RTM. Per il momento, ignorare l'arresto anomalo o disinstallare la versione SP1 Beta, se possibile.
