...
---
# <a name="quickstart-create-and-publish-a-package-using-visual-studio-net-framework-windows"></a>Avvio rapido: Creare e pubblicare un pacchetto con Visual Studio (.NET Framework, Windows)
