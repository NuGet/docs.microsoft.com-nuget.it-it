...
Per evitare questo problema, è necessario assicurarsi che i pacchetti vengano ripristinati come primo passaggio del processo di compilazione. NuGet 2.7+ facilita questa procedura tramite una riga di comando semplificata:
