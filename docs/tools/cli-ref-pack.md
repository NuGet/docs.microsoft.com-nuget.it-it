...
| Simboli | Specifica che il pacchetto contiene origini e simboli. Se usato con un `.nuspec` file, verrà creato un file di pacchetto NuGet normale e di pacchetto di simboli corrispondente. |
