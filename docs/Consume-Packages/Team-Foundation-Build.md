...
<span data-ttu-id="3ab41-131">La struttura del repository è simile alla seguente:</span><span class="sxs-lookup"><span data-stu-id="3ab41-131">The structure of the repository looks as follows:</span></span>
