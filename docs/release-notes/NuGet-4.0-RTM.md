...
- dotnet
  - dotnetcore Restore foo.sln -- non riesce quando le configurazioni nella soluzione causano progetti duplicati (ma configurazioni diverse) nel grafico di ripristino - [#4316](https://github.com/NuGet/Home/issues/4316)
...
- Esecuzione troppo frequente di pack -- dotnet
  - dotnetcore pack non riesce con l'errore È presente una dipendenza circolare nel grafico di dipendenze che usa la destinazione "Pack"  - [#4381](https://github.com/NuGet/Home/issues/4381)
...
- dotnet
  - dotnetcore pack non supporta title in `.csproj` - [#4150](https://github.com/NuGet/Home/issues/4150)
...
- dotnet
  - dotnetcore pack - ProjectReference perde le informazioni sulla versione - [#3953](https://github.com/NuGet/Home/issues/3953)
...
- dotnet
  - dotnetcore pack deve includere nel pacchetto strumenti con le versioni usate per la compilazione del pacchetto - [#4063](https://github.com/NuGet/Home/issues/4063)
...
- dotnet
  - Errore di dotnetcore pack quando PackagePath è vuoto - [#3993](https://github.com/NuGet/Home/issues/3993)
...
- dotnet
  - dotnetcore pack3 aggiunge elementi di divisione per i tag - [#3701](https://github.com/NuGet/Home/issues/3701)

- dotnet
  - dotnetcore pack: la creazione di un pacchetto di progetti con riferimenti ai pacchetti causa un avviso di importazione duplicata - [#3665](https://github.com/NuGet/Home/issues/3665)
...
- dotnet
  - dotnetcore pack crea il pacchetto da obj e non da bin - [#3880](https://github.com/NuGet/Home/issues/3880)

- dotnet
  - dotnetcore pack sembra impostare sempre la versione di ProjectReference su 1.0.0 - [#3874](https://github.com/NuGet/Home/issues/3874)

- dotnet
  - dotnetcore pack non riesce con riferimenti a progetti e <TargetFramework> - [#3865](https://github.com/NuGet/Home/issues/3865)
...
[Elenco di problemi 1](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0%20RTM")  
[Elenco di problemi 2](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0%20RC4")  
[Elenco di problemi 3](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0%20RC3")  
[Elenco di problemi 4](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0%20RC2")  
[Elenco di problemi 5](https://github.com/NuGet/Home/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%224.0%20RC")
