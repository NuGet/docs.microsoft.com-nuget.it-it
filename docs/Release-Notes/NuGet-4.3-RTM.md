...
---
# <a name="43-rtm-release-notes"></a>Note sulla versione per 4.3 RTM
...
#### <a name="workaround"></a>Soluzione temporanea:
...
* dotnet restore (e quindi msbuild /t:restore) ignora i progetti con una dipendenza esplicita da un progetto nella soluzione [#4578](https://github.com/NuGet/Home/issues/4578)
...
## <a name="link-to-github-issues-fixed-in-43-rtm"></a>Collegamento ai problemi di GitHub risolti nella versione 4.3 RTM
