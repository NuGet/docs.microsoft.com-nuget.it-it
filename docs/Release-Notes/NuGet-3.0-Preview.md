...
Tra l'ora e la versione 3.0 RTM, Microsoft sta lavorando alcune fondamentali nuove NuGet funzionalità, oltre a ciò che viene visualizzato nell'interfaccia utente. Ecco un breve elenco di aree di investimento principali:
